package com.moamap.app.feature.onboarding.domain.repository
...
interface AuthRepository {
     ...
     *
     * @throws com.moamap.app.feature.onboarding.domain.model.KakaoLoginCancelledException 사용자가 취소한 경우
     */
