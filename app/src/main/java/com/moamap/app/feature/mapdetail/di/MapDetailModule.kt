 ...
 * 이미 제공하고 있어 그대로 가져다 쓴다. 새로 만드는 건 카카오 로컬 서비스와 게시물 서비스다.
 */
@Module
...
internal abstract class MapDetailModule {
    ...
    companion object {
        ...
        @Provides
        @Singleton
        fun provideMapPostService(retrofit: Retrofit): MapPostService =
            retrofit.create(MapPostService::class.java)
    }
}
