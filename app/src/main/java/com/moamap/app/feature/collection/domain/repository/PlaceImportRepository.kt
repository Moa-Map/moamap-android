...
interface PlaceImportRepository {
     ...
     *
     * @throws com.moamap.app.feature.collection.domain.model.PlaceExtractionException 캡션을 읽지 못한 경우
     * @throws com.moamap.app.core.network.NetworkException 서버 호출이 실패한 경우
     */
